  ...
  return (
    <>
      ...
      <div className="flex flex-col gap-8">
        ...
        {/* Cards grid */}
        <ListCard className="bg-white dark:bg-boxdark rounded-lg shadow-default p-6" title="Cards items" onAdd={() => { setSelCard(null); setCardOpen(true); }} loading={loadingCards} empty={cards.length === 0}>
