  ...
  return (<ClickOutside onClick={() => setDropdownOpen(false)} className="relative">
    ...
    {dropdownOpen && (<div className={`absolute right-0 mt-7.5 flex w-[280px] flex-col rounded-lg border-[0.5px] border-stroke bg-white shadow-default dark:border-dark-3 dark:bg-gray-dark`}>
      ...
      <ul className="flex flex-col gap-1 border-y-[0.5px] border-stroke p-2.5 dark:border-dark-3">
        ...
        <li>
              <Link href="/dashboard/change-password" className="flex w-full items-center gap-2.5 rounded-[7px] p-2.5 text-sm font-medium text-dark-4 duration-300 ease-in-out hover:bg-gray-2 hover:text-dark dark:text-dark-6 dark:hover:bg-dark-3 dark:hover:text-white lg:text-base">
                 <Lock size={18} />
                Change Password
              </Link>
            </li> 
