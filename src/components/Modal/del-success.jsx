...
const DeleteSuccess = ({ DeleteModalSuccess, deleteModalName }) => {
            ...
            <div className="bg-green-100 p-3 mb-4 w-full ">
                <div className="flex justify-between">
                    <div className="flex space-x-3">
                        ...
                        <div class="flex-1 leading-tight text-sm text-green-700 font-medium">{deleteModalName} deleted successfully</div>
                    </div>
                    <svg onClick={(e) => DeleteModalSuccess(false)} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="flex-none fill-current text-green-600 h-3 w-3">
